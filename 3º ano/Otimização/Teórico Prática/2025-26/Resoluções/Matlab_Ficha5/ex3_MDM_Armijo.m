...
%% aplicar o algoritmo Método de Descida Máxima com procura de Armijo com backtracking
[w_opt,Fval_opt,output]=MDM_Armijo(@F10,@F10withgrad,w0,epsilon,Kmax)
...
title('Pontos gerados pelo MDM e trajetória')
grid on
