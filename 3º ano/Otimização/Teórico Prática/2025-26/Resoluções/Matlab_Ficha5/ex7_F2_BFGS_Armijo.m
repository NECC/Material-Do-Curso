...
[wopt,Fopt,output]=BFGS_Armijo(@F2,@F2withgrad,H0,w0,epsilon,Kmax,gamma)

%% gráfico das curvas de nível de F
% criar grelha de pontos
[w1,w2] = meshgrid(-3:0.01:3, -3:0.01:3);
vals_F = 4*w1.^2+2*w2.^2+4*w1.*w2-3*w1;
...
text(vals_w1(1)-0.2, vals_w2(1)+0.2,'w0')
